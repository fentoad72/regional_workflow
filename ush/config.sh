...
EXTRN_MDL_SOURCE_BASEDIR_ICS="/work/noaa/gsd-fv3-dev/gsketefia/UFS/staged_extrn_mdl_files/FV3GFS"
EXTRN_MDL_FILES_ICS=( "gfs.pgrb2.0p25.f000" )
EXTRN_MDL_SOURCE_BASEDIR_LBCS="/work/noaa/gsd-fv3-dev/gsketefia/UFS/staged_extrn_mdl_files/FV3GFS"
